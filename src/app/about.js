...
export default function About() {
  ...
  return (
    ...
    >
      ...
      <h3 className="text-md md:text-xl font-bold tracking-tight text-black mt-6 dark:text-slate-200">
        About
      </h3>
        <p className="mt-3 leading-8 text-black whitespace-normal text-balance text-sm md:text-lg dark:text-slate-200">
...
{/* Skills  */}
      <div>
        <h3 className="text-xl font-bold tracking-tight text-black sm:text-xl mt-6 dark:text-slate-200">
          My Skills
        </h3>
        <div className="mt-3 text-lg leading-8 text-black whitespace-normal dark:text-slate-200">
        ...
        <div className="mt-5 text-lg leading-8 text-black whitespace-normal dark:text-slate-200">
